...
- [ ] Live DataHub workflow is green on the exact merged commit.
- [ ] Seed report proves five datasets.
- [ ] Seed report proves 19 governed fields.
- [ ] Seed report proves four lineage relationships.
...
- [ ] JavaScript and CSS assets load from the correct `/toxicjoin/` subpath.
- [ ] Desktop layout has no error overlay or horizontal overflow.
- [ ] Mobile layout has no horizontal overflow or clipped controls.
...
- [ ] DataHub section shows the real live proof, not fixture or replay content presented as live.
...
- [ ] Technologies: `DataHub OSS / Core Platform` and `DataHub MCP Server`.
- [ ] Country: `Jordan`.
- [ ] Newly created during submission period: `Yes`.
- [ ] Public repository URL is correct.
- [ ] Project/demo URL is correct and publicly accessible.
- [ ] Examples URL is correct.
- [ ] Video URL is correct, public, and under three minutes.
- [ ] Feedback Prize answer has been reviewed.
- [ ] Upstream contribution field does not claim a contribution that does not exist.
...
- [ ] Live DataHub workflow is green.
