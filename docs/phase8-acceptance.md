...
4. The catalog distinguishes `current` from `historical` lifecycle and distinguishes `preview`, `submission`, and operational purpose.
...
Phase 8 does not create a tag, GitHub Release, public deployment, Devpost submission, PostgreSQL integration, ruleset, or repository cleanup.
