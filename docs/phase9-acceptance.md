...
2. project version `0.1.0`, tag `v0.1.0`, release name, notes, and assets agree;
...
7. release notes preserve `SINGLE_NODE`, PostgreSQL-not-canonical, Replay-not-live, and no-Devpost-submission boundaries;
8. the release workflow is idempotent and refuses a mismatched pre-existing tag or Release;
9. PR #118 remains isolated;
10. no Phase 10 ruleset work, Phase 11 cleanup, Phase 12 PostgreSQL disposition, Vercel, or Devpost mutation occurs.
