...
2. Follow the [90-second executable judge guide](../judge-testing.md) to run the real fixture-mode backend.
3. Read [live DataHub evidence](datahub-live.md) for the real OSS SDK/MCP integration and write-back proof.
4. Read [governance dependency](governance-dependency.md) to see why DataHub-governed context changes authorization outcomes.
5. Read [adversarial mutations](adversarial-mutations.md) and the [ablation](compositional-ablation.md) for robustness and originality evidence.
